// lib/features/leaderboard/providers/all_users_leaderboard_provider.dart
// ─────────────────────────────────────────────────────────────────────────────
...
/// Результат загрузки лидерборда всех пользователей
class AllUsersLeaderboardResult {
  final List<LeaderboardRowData> leaderboard;
  final int? currentUserRank;

  const AllUsersLeaderboardResult({
...
final allUsersLeaderboardProvider = FutureProvider.autoDispose
  ...
  (ref, params) async {
    ...
    return AllUsersLeaderboardResult(
...
class AllUsersLeaderboardParams {
  ...
  const AllUsersLeaderboardParams({
    this.sport = 0,
  ...
  bool operator ==(Object other) =>
      ...
      other is AllUsersLeaderboardParams &&
