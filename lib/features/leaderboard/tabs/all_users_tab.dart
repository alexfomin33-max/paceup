// lib/features/leaderboard/tabs/all_users_tab.dart
// ─────────────────────────────────────────────────────────────────────────────
// Вкладка "Все пользователи" лидерборда
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
class AllUsersTab extends ConsumerStatefulWidget {
  const AllUsersTab({super.key});

  @override
  ConsumerState<AllUsersTab> createState() => _AllUsersTabState();
}

class _AllUsersTabState extends ConsumerState<AllUsersTab>
