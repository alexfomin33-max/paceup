// lib/features/profile/screens/tabs/equipment/adding/tabs/own_bike_screen.dart
import 'dart:io';
...
/// Экран «Добавить свой велосипед» — для ввода произвольного бренда и модели
class OwnBikeScreen extends ConsumerStatefulWidget {
  const OwnBikeScreen({super.key});

  @override
  ConsumerState<OwnBikeScreen> createState() => _OwnBikeScreenState();
}

class _OwnBikeScreenState extends ConsumerState<OwnBikeScreen> {
  // ─────────────────────────────────────────────────────────────────────
  //                             КОНТРОЛЛЕРЫ
  // ─────────────────────────────────────────────────────────────────────
  ...
  final _pickerFocusNode = FocusNode(debugLabel: 'ownBikePickerFocus');
