...
class _ActivityDescriptionPageState
  ...
  double _getMapHeight(BuildContext context) {
    ...
    // Если есть маршрут, изображения или импортированная тренировка без маршрута
        ...
        body: NotificationListener<ScrollNotification>(
          ...
          child: NestedScrollView(
            headerSliverBuilder: (context, innerBoxIsScrolled) {
              // ────────────────────────────────────────────────────────────────
              // 🖼️ ДЕФОЛТНАЯ КАРТИНКА: для импортированных тренировок без маршрута
              // используем фиксированную высоту 350 пикселей
              // SliverAppBar автоматически добавляет SafeArea.top, поэтому вычитаем его
              // чтобы реальная высота контента была 350 пикселей (как в ActivityBlock)
              // ────────────────────────────────────────────────────────────────
              final stats = a.stats;
              final hasHeartRateOrCadence =
                  stats?.avgHeartRate != null || stats?.avgCadence != null;
              ...
              final baseHeight = isImportedWithoutRoute ? 350.0 : mapHeight;
                    ...
                    background: AnimatedOpacity(
                      ...
                      child: Builder(
                        builder: (context) {
                          ...
                          // Если импортированная тренировка без маршрута — показываем дефолтную картинку
                          if (isImportedWithoutRoute) {
                            // ────────────────────────────────────────────────────────────────
                          ...
                          // Если нет ни маршрута, ни изображений, ни пульса/каденса — ничего не показываем
