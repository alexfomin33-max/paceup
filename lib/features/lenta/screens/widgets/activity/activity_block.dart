                ...
                child: Builder(
                  builder: (context) {
                    ...
                    if (updatedActivity.points.isNotEmpty ||
                      ...
                      // ────────────────────────────────────────────────────────────────
                      // ⚡ ОПТИМИЗАЦИЯ: мемоизируем ActivityRouteCarousel через RepaintBoundary
                      // ────────────────────────────────────────────────────────────────
                      // Это предотвращает перерисовку карусели при обновлении лайков/комментариев
                      // Ожидаемый эффект: -25% лишних перерисовок карусели
                      // ────────────────────────────────────────────────────────────────
                      // ⚡ ОПТИМИЗАЦИЯ: используем предвычисленный routePoints
                      // ────────────────────────────────────────────────────────────────
                      return RepaintBoundary(
                        child: ActivityRouteCarousel(
                          points:
                              routePoints, // ⚡ Используем кэшированное значение
