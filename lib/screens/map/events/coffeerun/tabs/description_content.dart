  ...
  Widget build(BuildContext context) {
    ...
    return const Column(
      ...
      children: [
        ...
        SizedBox(height: 10),
        Text(
          '📍 Паркуемся и стартуем от Маркета на горе (финиш там же).',
          style: style,
        ),
        SizedBox(height: 10),
        Text(
          '⏰ Встречаемся в 8:00 у входа в Маркет рядом с Братом.',
          style: style,
        ),
        SizedBox(height: 10),
        ...
        SizedBox(height: 10),
        Text(
          '🗺 Маршрут по главным улицам города, 4–7 км с остановками для фото 📸.',
          style: style,
        ),
        SizedBox(height: 10),
